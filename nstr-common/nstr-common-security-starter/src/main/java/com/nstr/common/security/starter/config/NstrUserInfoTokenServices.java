 ...
 * @date: 2021.08.17
 */
public class NstrUserInfoTokenServices implements ResourceServerTokenServices {
    ...
    public NstrUserInfoTokenServices(String userInfoEndpointUrl, String clientId) {
