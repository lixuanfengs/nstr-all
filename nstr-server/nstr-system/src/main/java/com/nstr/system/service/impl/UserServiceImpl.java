...
import com.nstr.system.mapper.UserMapper;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, SystemUser> implements IUserService {
    ...
    @Override
    public void updateProfile(SystemUser user) throws NstrException {
    ...
    public IPage<SystemUser> findUserDetailList(SystemUser user, QueryRequest request) {
        ...
        SortUtil.handlePageSort(request, page, "userId", NstrConstant.ORDER_ASC, false);
